    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col items-center justify-center p-4 sm:p-6 selection:bg-indigo-500/30">
      ...
      <div className="max-w-md w-full bg-white dark:bg-slate-900 rounded-2xl sm:rounded-[3rem] border border-slate-200 dark:border-slate-800 overflow-hidden shadow-2xl animate-in zoom-in-95 duration-500">
        ...
        <div className="p-6 sm:p-10 pb-4 text-center">
          ...
          <h1 className="text-xl sm:text-2xl font-bold text-slate-900 dark:text-white tracking-tight">Create Store Account</h1>
          <p className="text-xs sm:text-sm font-medium text-slate-500 mt-1">Start managing your business with the most powerful SaaS platform.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 sm:p-10 pt-4 sm:pt-6 space-y-4 sm:space-y-6">
              ...
              <div key={field.name} className="space-y-2">
                ...
                <div className="relative group">
                    <div className="absolute left-4 top-1/2 -translate-y-1/2 w-8 h-8 flex items-center justify-center bg-slate-100 dark:bg-slate-800 rounded-lg group-focus-within:bg-indigo-50 dark:group-focus-within:bg-indigo-950/30 transition-colors">
                        <field.icon className="w-4 h-4 text-slate-400 group-focus-within:text-indigo-600 transition-colors animate-none" />
                    </div>
                    <input
                        name={field.name}
                        type={field.type}
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-4 sm:py-5 rounded-xl sm:rounded-2xl font-bold uppercase tracking-widest transition-all shadow-xl shadow-indigo-600/20 active:scale-95 flex items-center justify-center gap-3 disabled:opacity-50 mt-4 cursor-pointer text-xs sm:text-sm"
          >
          ...
          <div className="pt-6 sm:pt-8 text-center border-t border-slate-100 dark:border-slate-800 mt-4">
            <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-3 sm:mb-4">Already managing a store?</p>
            <button
              type="button"
